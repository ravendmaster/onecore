...
public class WidgetEditorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.close:
                ...
                widget.deviceId = device_id;//AppSettings.getInstance().getDevicesIdByIndex(spinner_widget_mode.getSelectedItemPosition());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_device_id = ((Spinner) findViewById(R.id.spinner_device_id));
        ...
        String[] devices = AppSettings.getInstance().getDeviceNames();
        ArrayAdapter<String> adapter_devices = new ArrayAdapter<String>(mWidgetEditorActivity, android.R.layout.simple_spinner_item, devices);
        adapter_devices.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_device_id.setAdapter(adapter_devices);
        spinner_device_id.setSelection(AppSettings.getInstance().getDeviceIndexById(tempWidgetData.deviceId));
        spinner_device_id.setPrompt("Device");
        spinner_device_id.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                device_id = AppSettings.getInstance().getDevicesIdByIndex(position);
            }
        ...
        device_id = tempWidgetData.deviceId;
